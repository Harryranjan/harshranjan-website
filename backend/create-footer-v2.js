...
async function createComprehensiveFooter() {
  try {
    ...
    const footerData = {
      ...
      location: "footer",
      description: "Professional footer with company info, services, resources, and social links",
      is_active: true,
      settings: {
        type: "footer-builder",
        layout: "4-column",
        columns: [
          ...
          },
          {
            ...
            items: [
              ...
              { label: "Social Media Marketing", url: "/services/social-media" },
        ...
        copyright: {
          enabled: true,
          text: "Â© 2025 Harsh Ranjan Digital. All rights reserved. | Empowering brands through innovative digital marketing solutions."
        },
        socialIcons: {
          enabled: true,
          icons: [
            { name: "LinkedIn", url: "https://linkedin.com/in/harshranjan", icon: "LI" },
            { name: "Twitter", url: "https://twitter.com/harshranjan", icon: "TW" },
            { name: "Facebook", url: "https://facebook.com/harshranjan", icon: "FB" },
            { name: "Instagram", url: "https://instagram.com/harshranjan", icon: "IG" },
            { name: "YouTube", url: "https://youtube.com/@harshranjan", icon: "YT" },
            { name: "GitHub", url: "https://github.com/harryranjan", icon: "GH" }
          ]
        },
        newsletter: {
          enabled: true,
          title: "Subscribe to Our Newsletter",
          subtitle: "Get the latest insights, tips, and strategies delivered to your inbox",
    ...
    console.log('\nâœ… Comprehensive footer created successfully!');
    ...
    console.log(`- Social Media: 6 platforms (LinkedIn, Twitter, Facebook, Instagram, YouTube, GitHub)`);
