        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden mb-8">
            <div class="grid lg:grid-cols-5 gap-0">
                ...
                <div class="lg:col-span-2 relative">
                    ...
                    <!-- Stats Badge Overlay -->
                    <div class="absolute bottom-3 left-3 right-3 bg-white/95 backdrop-blur-sm rounded-lg p-2 shadow-lg">
...
async function reduceImageHeight() {
  const connection = await mysql.createConnection(dbConfig);

  try {
    console.log("\n📏 Reducing Image Height for Compact Section...\n");
    ...
    if (aboutStartIndex > -1 && quickContactIndex > -1) {
      ...
      const newContent = beforeAbout + compactHeightAbout + "\n\n" + afterAbout;
      ...
      console.log("========================================");
      console.log("✅ IMAGE HEIGHT REDUCED!");
      console.log("========================================\n");

      console.log("📏 HEIGHT REDUCTIONS:\n");
      console.log("Image:");
      console.log("  ✓ min-h: 320px → 280px (12.5% reduction)");
      console.log("  ✓ Badge overlay: smaller (p-2, text-xs)");
      console.log("  ✓ Badge icons: reduced size\n");

      console.log("Content Padding:");
      console.log("  ✓ Card padding: p-6 → p-5");
      console.log("  ✓ Section margins: mb-4 → mb-3");
      console.log("  ✓ Grid gaps: gap-2 → gap-1.5");
      console.log("  ✓ All spacing tightened\n");

      console.log("Typography:");
      console.log("  ✓ Doctor name: text-2xl → text-xl");
      console.log("  ✓ Paragraph: text-sm → text-xs");
      console.log("  ✓ Stats: text-2xl → text-lg");
      console.log("  ✓ Everything smaller\n");

      console.log("Result:");
      console.log("  ✅ ~25% overall height reduction");
      console.log("  ✅ Section much more compact");
      console.log("  ✅ Content matches image height");
      console.log("  ✅ Professional & tight design\n");

      console.log("========================================");
      console.log("Much more compact now! 📏");
      console.log("========================================\n");
    } else {
