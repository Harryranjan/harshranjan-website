...
async function removeJKTiwariCorrectly() {
  ...
  let cardStart = content.lastIndexOf(
  ...
  console.log(
    'Contains "J.K. Tiwari":',
    removedSection.includes("J.K. Tiwari")
  );
  console.log(
    'Contains "Subodh Kumar":',
    removedSection.includes("Subodh Kumar")
  );

  if (removedSection.includes("Subodh Kumar")) {
    console.log(
      "⚠️ WARNING: This section contains Dr. Subodh Kumar! Not removing."
    );
    await connection.end();
    return;
  }
  ...
  // Remove the section
  const newContent =
    content.substring(0, cardStart) + content.substring(cardEnd);
  ...
  console.log(
    "Dr. J.K. Tiwari still present:",
    newContent.includes("Dr. J.K. Tiwari")
  );
  console.log(
    "Dr. Subodh Kumar still present:",
    newContent.includes("Dr. Subodh Kumar")
  );
