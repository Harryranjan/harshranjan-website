...
(async () => {
  try {
    ...
    if (pages.length === 0) {
      ...
      console.log('   To use dynamic pages with shortcodes, access via /pages/homepage');
    ...
    const hasCTAShortcode = page.content && page.content.includes('[cta_banner');
    
    console.log('\n🔍 Shortcode Detection:');
    console.log('   [form] shortcode:', hasFormShortcode ? '✅ FOUND' : '❌ Not found');
    console.log('   [modal] shortcode:', hasModalShortcode ? '✅ FOUND' : '❌ Not found');
    console.log('   [popup] shortcode:', hasPopupShortcode ? '✅ FOUND' : '❌ Not found');
    console.log('   [cta_banner] shortcode:', hasCTAShortcode ? '✅ FOUND' : '❌ Not found');
