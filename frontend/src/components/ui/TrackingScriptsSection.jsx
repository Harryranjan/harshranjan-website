            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">
                  ...
                  section • Best for analytics & tracking
                </p>
              </div>
            </div>
  ...
  gtag('config', 'G-XXXXXXXXXX');
          ...
          <div className="flex items-start gap-2 bg-purple-50 border border-purple-200 rounded-lg p-3">
            ...
            <div className="text-xs text-purple-800">
              <span className="font-semibold">Best for:</span> Facebook Pixel,
              Google Analytics (GA4), Google Tag Manager, Google Ads conversion
...
<script>(function(){var w=window;var ic=w.Intercom;...})();</script>`}
          ...
          <div className="flex items-start gap-2 bg-emerald-50 border border-emerald-200 rounded-lg p-3">
            ...
            <div className="text-xs text-emerald-800">
              <span className="font-semibold">Best for:</span> Google Tag
              Manager (noscript), Live chat widgets (Intercom, Drift), Heatmap
              tools (Hotjar, Crazy Egg), Pop-ups
            </div>
          </div>
        </div>
            ...
            <div className="flex-1">
              ...
              <ul className="space-y-2 text-xs text-amber-800">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Always test:</strong> Use browser dev tools to
                ...
                <li className="flex items-start gap-2">
                  <span className="text-amber-600 font-bold mt-0.5">•</span>
                  <span>
                    <strong>Complete tags:</strong> Include full &lt;script&gt;
                    or &lt;noscript&gt; tags
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-amber-600 font-bold mt-0.5">•</span>
                  <span>
                    <strong>Performance:</strong> Too many scripts can slow down
                    your page load time
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-amber-600 font-bold mt-0.5">•</span>
                  <span>
                    <strong>Privacy:</strong> Ensure compliance with GDPR/CCPA
                    when using tracking codes
                  </span>
                </li>
              </ul>
            </div>
