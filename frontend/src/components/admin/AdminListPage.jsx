      ...
      <div className="container mx-auto px-4 py-8">
        <EmptyState
          ...
          description={
            ...
            `Get started by creating your first ${resource.singular.toLowerCase()}.`
          }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <ConfirmationModal
        ...
        message={`Are you sure you want to delete "${
          itemToDelete?.title || itemToDelete?.name || "this item"
      ...
      <ConfirmationModal
        ...
        title={`Delete ${selectedItems.length} ${
          selectedItems.length === 1 ? resource.singular : resource.name
        }`}
        message={`Are you sure you want to delete ${selectedItems.length} ${
          selectedItems.length === 1
            ? resource.singular.toLowerCase()
            : resource.name.toLowerCase()
        }? This action cannot be undone.`}
        confirmLabel={`Delete ${selectedItems.length} Item${
