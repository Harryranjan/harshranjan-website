      ...
      >
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          <h1 className="text-6xl md:text-8xl font-black text-white mb-6 leading-none tracking-tight">
            ...
            <span className="block text-5xl md:text-7xl text-white/80">
              EXPERIENCES
            </span>
          </h1>

          <p className="text-xl md:text-2xl text-white/70 mb-12 max-w-4xl mx-auto leading-relaxed">
            We create award-winning digital products that combine stunning
            design with cutting-edge technology to deliver exceptional user
            experiences.
          </p>
        ...
        <div className="container mx-auto px-6 relative">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-white/60 max-w-3xl mx-auto leading-relaxed">
              We specialize in creating digital experiences that not only look
            ...
            {[
              {
                ...
                description:
                  "Lightning-fast websites built with cutting-edge technologies and optimized for performance.",
                icon: "⚡",
              ...
              },
              {
                title: "UI/UX Design",
                description:
                  "User-centered designs that convert visitors into customers and drive engagement.",
                icon: "🎨",
              ...
              },
              {
                ...
                description:
                  "Memorable brand experiences that tell your story and connect with your audience.",
                icon: "✨",
              ...
              },
              {
                title: "E-commerce",
                description:
                  "Powerful online stores that maximize conversions and provide seamless shopping experiences.",
                icon: "🛍️",
              ...
              },
              {
                title: "Consulting",
                description:
                  "Strategic guidance to help you make informed decisions about your digital presence.",
                icon: "🚀",
              ...
              >
                ...
                <div
                  className={`absolute inset-0 rounded-3xl bg-gradient-to-r ${service.gradient} opacity-0 group-hover:opacity-20 transition-opacity duration-500 -z-10`}
                ></div>

                {/* Icon */}
                <div
                  className={`w-16 h-16 bg-gradient-to-r ${service.gradient} rounded-2xl flex items-center justify-center text-2xl mb-6 group-hover:scale-110 transition-all duration-300`}
                >
                  {service.icon}
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-white/70 mb-12 leading-relaxed">
                ...
                in the power of great design to transform businesses and create
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md border border-white/20 rounded-3xl p-8 group hover:scale-105 transition-all duration-500">
                ...
                <div className="relative z-10">
                  <div className="text-8xl mb-6 filter grayscale hover:grayscale-0 transition-all duration-500">
                    🎯
                  </div>
                  ...
                  <p className="text-white/70 leading-relaxed">
                    ...
                    but also drive real business results and meaningful user
                    engagement.
                  </p>
                </div>
              </div>
            ...
            {[
              {
                ...
                role: "CEO, TechStart",
                content:
                  "Working with this team was absolutely phenomenal. They transformed our vision into a stunning reality that exceeded all expectations.",
                rating: 5,
                avatar: "👩‍💼",
              ...
              },
              {
                ...
                content:
                  "Our website traffic increased by 400% after the redesign. The attention to detail and user experience is unmatched.",
                rating: 5,
                avatar: "👨‍💻",
                company: "GrowthLab",
              },
              {
                ...
                content:
                  "The most professional and creative team I've worked with. They truly understand modern design and user psychology.",
                rating: 5,
                avatar: "👩‍🎨",
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Let's discuss your project and turn your ideas into reality. Contact
