      ...
      if (bulkAction === "delete") {
        ...
        await Promise.all(
          selectedPages.map((id) =>
            api.put(`/pages/${id}`, { status: "published" })
          )
        );
      } else if (bulkAction === "draft") {
        await Promise.all(
          selectedPages.map((id) =>
            api.put(`/pages/${id}`, { status: "draft" })
          )
        );
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setFilter({ ...filter, template: e.target.value })
                }
                className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm"
              >
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2 flex-1">
              ...
              >
                ...
                <option value="template-services">
                  ...
                  >
                    ...
                    <td className="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex items-center justify-end gap-1.5">
                        ...
                        <button
                          onClick={() =>
                            handleQuickPublish(page.id, page.status)
                          }
            ...
            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
              <div>
                <p className="text-sm text-gray-700">
                  ...
                  of <span className="font-medium">{totalCount}</span> pages
                </p>
              </div>
              <div>
