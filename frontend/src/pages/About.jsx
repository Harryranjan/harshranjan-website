...
const About = () => {
  ...
  const timeline = [
    { year: "2018", title: "Started Journey", description: "Began freelancing in digital marketing" },
    { year: "2019", title: "First Major Client", description: "Managed ₹10L+ ad budget for D2C brand" },
    { year: "2021", title: "AI Integration", description: "Started implementing AI-powered marketing systems" },
    { year: "2023", title: "Scale & Growth", description: "Expanded to serve 100+ brands across India" },
    { year: "2025", title: "Innovation Leader", description: "Leading AI-powered marketing transformation" },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
                7+ Years of Transforming Brands Through AI-Powered Marketing. From freelancer to AI marketing innovator - helping 200+ brands achieve extraordinary results.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-black font-display text-gray-900 mb-4">
              My Journey in <span className="gradient-text">Digital Marketing</span>
            </h2>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
                <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                  <p className="flex items-start">
                    ...
                    <span>With over <strong className="text-purple-600 font-bold">7 years of experience</strong> in digital marketing, I've helped <strong className="text-cyan-600 font-bold">200+ brands</strong> across India transform their online presence and achieve measurable growth.</span>
                  </p>
                  <p className="flex items-start">
                    <i className="fas fa-check-circle text-cyan-600 mt-1 mr-3 flex-shrink-0"></i>
                    <span>My journey started with a <strong className="text-gray-900">passion for understanding consumer behavior</strong> and leveraging data to drive marketing decisions. Today, I specialize in <strong className="text-purple-600 font-bold">AI-powered marketing solutions</strong> that combine creativity with cutting-edge technology.</span>
                  </p>
                  <p className="flex items-start">
                    <i className="fas fa-check-circle text-purple-600 mt-1 mr-3 flex-shrink-0"></i>
                    <span>From UGC content creation to marketing automation and campaign management, I've built systems that help businesses <strong className="text-gray-900">scale their marketing efforts</strong> while reducing costs and <strong className="text-cyan-600 font-bold">improving ROI by 245%</strong> on average.</span>
                  </p>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 mt-8 pt-8 border-t border-gray-200">
                  <div className="text-center">
                    <div className="text-3xl font-black gradient-text mb-1">7+</div>
                  ...
                  <div className="text-center">
                    <div className="text-3xl font-black gradient-text mb-1">245%</div>
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100">
            <div className="text-center mb-8">
              <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-purple-100 to-cyan-100 px-4 py-2 rounded-full mb-4">
                ...
                <span className="text-sm font-bold text-gray-900">Verified Credentials</span>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="bg-white rounded-2xl p-8 text-center shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2">
              ...
              <div className="text-5xl font-black text-gray-900 mb-2">{counters.years}+</div>
            ...
            <div className="bg-white rounded-2xl p-8 text-center shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2">
              ...
              <div className="text-5xl font-black text-gray-900 mb-2">{counters.brands}+</div>
            ...
            <div className="bg-white rounded-2xl p-8 text-center shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2">
              ...
              <div className="text-5xl font-black text-gray-900 mb-2">₹{counters.adSpend.toFixed(1)}Cr+</div>
            ...
            <div className="bg-white rounded-2xl p-8 text-center shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2">
              ...
              <div className="text-5xl font-black text-gray-900 mb-2">{counters.videos}+</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {skills.map((skill, idx) => (
              <div key={idx} className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 shadow-md hover:shadow-xl transition-all hover:-translate-y-1 border border-gray-100">
                <div className="flex items-center justify-between mb-5">
                  ...
                  <span className="text-2xl font-black text-gray-900">{skill.level}%</span>
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-purple-50 to-white p-8 border-2 border-purple-200 rounded-2xl hover:border-purple-600 hover:shadow-2xl transition-all hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Creating <strong>authentic, engaging</strong> user-generated content that resonates
                with your audience and drives conversions.
              </p>
            </div>
            <div className="bg-gradient-to-br from-cyan-50 to-white p-8 border-2 border-cyan-200 rounded-2xl hover:border-cyan-600 hover:shadow-2xl transition-all hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Building <strong>AI-powered automation</strong> systems that streamline your
                marketing operations and improve efficiency.
              </p>
            </div>
            <div className="bg-gradient-to-br from-orange-50 to-white p-8 border-2 border-orange-200 rounded-2xl hover:border-orange-600 hover:shadow-2xl transition-all hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                <strong>End-to-end campaign</strong> management from strategy to execution,
      ...
      <section className="py-20 animated-gradient relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-white mb-12 leading-relaxed max-w-4xl mx-auto font-medium">
            "Great marketing isn't about <strong className="text-cyan-300 font-bold">shouting louder</strong>—it's about <strong className="text-white font-bold">understanding deeper</strong>. I believe in combining data-driven insights with creative storytelling to build authentic connections between brands and their audiences."
          </p>
          ...
          <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 md:p-12 shadow-2xl border border-white/20">
            <div className="grid md:grid-cols-3 gap-8 md:gap-12">
              <div className="group cursor-pointer">
                ...
                <div className="text-4xl md:text-5xl font-black text-white mb-3">Data</div>
                <p className="text-lg text-white/90 font-medium">Decisions backed by analytics</p>
              </div>
              ...
              <div className="group cursor-pointer">
                ...
                <div className="text-4xl md:text-5xl font-black text-white mb-3">Creativity</div>
                <p className="text-lg text-white/90 font-medium">Stories that captivate</p>
              </div>
              ...
              <div className="group cursor-pointer">
                ...
                <div className="text-4xl md:text-5xl font-black text-white mb-3">Results</div>
                <p className="text-lg text-white/90 font-medium">Measurable business impact</p>
              </div>
            </div>
          </div>
        </div>
