        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-blue-50 rounded-xl p-6 mb-8">
            ...
            <ol className="space-y-2 text-sm text-blue-800">
              <li><strong>1.</strong> Click on any variant card above to preview it</li>
              <li><strong>2.</strong> Scroll the page to see scroll-triggered variants</li>
              <li><strong>3.</strong> Try the CTA buttons and dismiss functionality</li>
              <li><strong>4.</strong> Test on mobile by resizing your browser</li>
              <li><strong>5.</strong> Choose your favorite and add it to your layout!</li>
            </ol>
          </div>
          ...
          <div className="bg-gradient-to-r from-red-500 to-red-600 rounded-xl p-8 text-white">
            ...
            <div className="space-y-4">
              <div className="bg-white bg-opacity-10 rounded-lg p-4">
                <div className="font-bold mb-2">🥇 Best for Desktop: Smart Header</div>
                <p className="text-sm text-red-50">
                  Provides full information initially, then stays visible without being intrusive
                </p>
              </div>
              
              <div className="bg-white bg-opacity-10 rounded-lg p-4">
                <div className="font-bold mb-2">🥇 Best for Mobile: Floating Button</div>
                <p className="text-sm text-red-50">
              ...
              <div className="bg-white bg-opacity-10 rounded-lg p-4">
                <div className="font-bold mb-2">🥇 Best Overall: Sticky Top (Your Design)</div>
                <p className="text-sm text-red-50">
                  Maximum visibility, professional appearance, works on all devices
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 space-y-8">
            <div className="bg-white rounded-xl p-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                Our ROI audits help businesses optimize their advertising spend and maximize returns.
                We've worked with top brands managing over ₹300+ Crores in ad spends, delivering
              ...
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="mb-4 p-4 bg-gray-50 rounded-lg">
                  <p className="text-gray-700">
                    Client testimonial or success story #{i}. This is placeholder content
                    to demonstrate scrolling behavior and how different banner variants appear.
                  </p>
                </div>
              ))}
            </div>
